...
全体ロードマップ: [docs/typescript-migration-roadmap.md](../typescript-migration-roadmap.md)

## 中長期 (next 6 months 想定)

### 機能
- **国際化 (i18n)** 完成: ✅ v2.0.37 で英語/日本語の完全二言語化を達成
...
- **日本語 / 英語 のサポート二言語化**: ✅ v2.0.37 で達成 (UI とドキュメント両方)
...
| 2026-05-16 | i18n 完全二言語化を ✅ 完了に更新 (v2.0.37) |
